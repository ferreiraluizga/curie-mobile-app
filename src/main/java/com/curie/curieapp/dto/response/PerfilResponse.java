...
public record PerfilResponse(Integer id, User user, String descricao, Comportamento comportamento, Temperamento temperamento, AreaConhecimento forca, AreaConhecimento fraqueza) {
}
